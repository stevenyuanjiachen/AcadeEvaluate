...
def create_dataset_folder(client, pdf_file_path, pdf_folder_path, db_folder_absolute_path, specified_folder_name):
    """
    ...
    with open(list_file_path, 'w') as list_file:
        ...
        for pdf_id in pdf_folder_ids:
            list_file.write(f'{pdf_id}\n')

def delete_dataset_folder(client, db_folder_absolute_path, specified_folder_name):
    """
...
def get_dataset_content(client, db_folder_absolute_path, specified_folder_name):
    ...
    prompt_context += "请分别归纳一下每一篇论文的内容，并说明他们之间的相互引用关系以及相互的评价，特别是所有论文对于第一篇论文的评价"
